  ...
  <div class="livros">
              ...
              <div>
                <input type="text" id="divBusca" placeholder="Buscar..."/>
                  ...
                  <p>Olá Seja bem-vindo(a).  <strong><?php session_start(); echo $_SESSION['Nome']; ?></strong>  </p>
              </div>
          ...
          <div class="listalivro">
            <center> 
			 ...
			 <form name="incCliente" action="../controllers/empresta.php" method=POST>
			 
			 <input type="hidden" name="esconde" value="1"/>
              
			  <input type="submit" name="Submit" value="Emprestar">
			  </form>
          </div>
          ...
          <div class="listalivro">
            <center> 
			 ...
			 <input type="hidden" name="esconde" value="2"/>
            ...
            <center> 
			 ...
			 <input type="hidden" name="esconde" value="3"/>
           ...
           <div class="listalivro">
            <center> 
			 ...
			 <input type="hidden" name="esconde" value="4"/>
          ...
          <div class="listalivro">
            <center> 
			 ...
			 <input type="hidden" name="esconde" value="5"/>
		  ...
		  <div class="listalivro">
            <center> 
			 ...
			 <input type="hidden" name="esconde" value="6"/>
